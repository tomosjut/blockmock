...
export const createEndpoint = (ep: Partial<MockEndpoint>): Promise<MockEndpoint> => postJson(BASE, ep)
export const updateEndpoint = (id: number, ep: Partial<MockEndpoint>): Promise<MockEndpoint> => putJson(`${BASE}/${id}`, ep)
